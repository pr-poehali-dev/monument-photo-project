...
export default function Index() {
  ...
  const monuments = [
    {
      id: 1,
      title: "Гранитный памятник",
      description: "Элегантный памятник из черного гранита с цветочной гравировкой",
      price: "от 25 000 ₽",
      image: "/img/3d540c17-ef48-4e89-b3ea-76d298ea29f3.jpg"
    },
    {
      id: 2,
      title: "Мраморный надгробие",
      description: "Черный мрамор с золотыми буквами и крестом",
      price: "от 35 000 ₽",
      image: "/img/bbf3ab13-3f2a-46ca-a431-e1d698f0355f.jpg"
    },
    {
      id: 3,
      title: "Современный монумент",
      description: "Белый камень с ангельской скульптурой",
      price: "от 45 000 ₽",
      image: "/img/7ffb68dd-f497-4483-914a-01589b1b4489.jpg"
    }
  ];
